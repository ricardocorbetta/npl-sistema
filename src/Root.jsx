...
export default function Root() {
  ...
  if (currentModule === 'presupuestos') return <ThemeContext.Provider value={themeCtx}><Layout key="presupuestos" current={currentModule} onNav={navTo} apps={apps} onLogout={logout} perfil={perfil} theme={theme} toggle={toggle} palette={palette}><App deepLinkId={deepLinkId} onNav={navTo} /></Layout></ThemeContext.Provider>
  if (currentModule === 'proyectos') return <ThemeContext.Provider value={themeCtx}><Layout key="proyectos" current={currentModule} onNav={navTo} apps={apps} onLogout={logout} perfil={perfil} theme={theme} toggle={toggle} palette={palette}><Proyectos deepLinkId={deepLinkId} perfil={perfil} onNav={navTo} /></Layout></ThemeContext.Provider>
  if (currentModule === 'planificacion') return <ThemeContext.Provider value={themeCtx}><Layout key="planificacion" current={currentModule} onNav={navTo} apps={apps} onLogout={logout} perfil={perfil} theme={theme} toggle={toggle} palette={palette}><Planificacion perfil={perfil} onNav={navTo} /></Layout></ThemeContext.Provider>
  if (currentModule === 'perfil') return <ThemeContext.Provider value={themeCtx}><Layout key="perfil" current={currentModule} onNav={navTo} apps={apps} onLogout={logout} perfil={perfil} theme={theme} toggle={toggle} palette={palette}><PanelPerfil perfil={perfil} palette={palette} onVolver={() => navTo(null)} /></Layout></ThemeContext.Provider>
  if (currentModule === 'legajos') return <ThemeContext.Provider value={themeCtx}><Layout key="legajos" current={currentModule} onNav={navTo} apps={apps} onLogout={logout} perfil={perfil} theme={theme} toggle={toggle} palette={palette} hideBuscador={true}><Proyectos deepLinkId={deepLinkId} perfil={perfil} onNav={navTo} /></Layout></ThemeContext.Provider>
  if (currentModule === 'calculistas') return <ThemeContext.Provider value={themeCtx}><Layout key="calculistas" current={currentModule} onNav={navTo} apps={apps} onLogout={logout} perfil={perfil} theme={theme} toggle={toggle} palette={palette}><Calculistas /></Layout></ThemeContext.Provider>
  if (currentModule === 'crm') return <ThemeContext.Provider value={themeCtx}><Layout key="crm" current={currentModule} onNav={navTo} apps={apps} onLogout={logout} perfil={perfil} theme={theme} toggle={toggle} palette={palette}><CRM /></Layout></ThemeContext.Provider>
  if (currentModule === 'dashboard') return <ThemeContext.Provider value={themeCtx}><Layout key="dashboard" current={currentModule} onNav={navTo} apps={apps} onLogout={logout} perfil={perfil} theme={theme} toggle={toggle} palette={palette}><Dashboard onNav={navTo} /></Layout></ThemeContext.Provider>
  if (currentModule === 'obras') return <ThemeContext.Provider value={themeCtx}><Layout key="obras" current={currentModule} onNav={navTo} apps={apps} onLogout={logout} perfil={perfil} theme={theme} toggle={toggle} palette={palette}><Obras perfil={perfil} onLogout={logout} deepLinkId={deepLinkId} /></Layout></ThemeContext.Provider>
  if (currentModule === 'biblioteca') return <ThemeContext.Provider value={themeCtx}><Layout key="biblioteca" current={currentModule} onNav={navTo} apps={apps} onLogout={logout} perfil={perfil} theme={theme} toggle={toggle} palette={palette}><Biblioteca /></Layout></ThemeContext.Provider>
  if (currentModule === 'configuracion') return <ThemeContext.Provider value={themeCtx}><Layout key="configuracion" current={currentModule} onNav={navTo} apps={apps} onLogout={logout} perfil={perfil} theme={theme} toggle={toggle} palette={palette}><Configuracion /></Layout></ThemeContext.Provider>
  if (currentModule === 'usuarios') return <ThemeContext.Provider value={themeCtx}><Layout key="usuarios" current={currentModule} onNav={navTo} apps={apps} onLogout={logout} perfil={perfil} theme={theme} toggle={toggle} palette={palette}><Usuarios session={session} palette={palette} /></Layout></ThemeContext.Provider>
